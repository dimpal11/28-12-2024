...
function Feacture() {
  return (
    <div>
      <section className='container max-w-screen-xl py-0 md:py-5 relative px-0 md:px-4 mx-auto overflow-x-hidden bg-gray-50'>
        ...
        <div className='bg-white hover:bg-[#FFEDE0] transition-transform duration-300 p-5 rounded-lg shadow-md text-center lg:text-start'>
          <div className='mb-4 bg-[#F6F7FB] hover:bg-[#E6A371] transition-transform duration-300  w-[50px] lg:w-[50px] rounded flex items-center justify-center p-3 mx-auto lg:mx-0'>
            <Image src={Logo} alt='Logo'></Image>
          </div>
          <h3 className='lg:text-sm text-sm font-extrabold text-[#072B2C] flex items-center gap-3 mt-4 mb-3 '><span><Image src={Dot} alt='logo'></Image></span>Live Metals Rate Updates</h3>
          <p className='text-[#072B2C] mt-2 text-[10px] lg:text-[10px] font-normal '>Lorem ipsum dolor sit amet consectetur. Potenti <br/> nullam at aenean ante ac enim mattis vestibulum <br/>vitae. Sit dolor id purus adipiscing dolor cursus <br/> sagittis pharetra sodales. Ut malesuada quam <br/>turpis euismod blandit. Rhoncus proin aliquet <br/> risus massa pellentesque elit. Non eget.</p>
        </div>
...
<div className='bg-white hover:bg-[#FFEDE0] transition-transform duration-300 p-5 rounded-lg shadow-md text-center lg:text-start'>
          ...
          <h3 className='lg:text-sm text-sm font-extrabold text-[#072B2C] flex items-center gap-3 mt-4 mb-3 '><span><Image src={Dot} alt='logo'></Image></span>Sales / Tax Management</h3>
          <p className='text-[#072B2C] mt-2 text-[10px] lg:text-[10px] font-normal '>Lorem ipsum dolor sit amet consectetur. Potenti <br/> nullam at aenean ante ac enim mattis vestibulum <br/>vitae. Sit dolor id purus adipiscing dolor cursus <br/> sagittis pharetra sodales. Ut malesuada quam <br/>turpis euismod blandit. Rhoncus proin aliquet <br/> risus massa pellentesque elit. Non eget.</p>
        </div>
...
<div className='bg-white hover:bg-[#FFEDE0] transition-transform duration-300 p-5 rounded-lg shadow-md text-center lg:text-start'>
          ...
          <h3 className='lg:text-sm text-sm font-extrabold text-[#072B2C] flex items-center gap-3 mt-4 mb-3 '><span><Image src={Dot} alt='logo'></Image></span>Inventory Management</h3>
          <p className='text-[#072B2C] mt-2 text-[10px] lg:text-[10px] font-normal '>Lorem ipsum dolor sit amet consectetur. Potenti <br/> nullam at aenean ante ac enim mattis vestibulum <br/>vitae. Sit dolor id purus adipiscing dolor cursus <br/> sagittis pharetra sodales. Ut malesuada quam <br/>turpis euismod blandit. Rhoncus proin aliquet <br/> risus massa pellentesque elit. Non eget.</p>
        </div>
...
<div className='bg-white hover:bg-[#FFEDE0] transition-transform duration-300 p-5 rounded-lg shadow-md text-center lg:text-start'>
          ...
          <h3 className='lg:text-sm text-sm font-extrabold text-[#072B2C] flex items-center gap-3 mt-4 mb-3 '><span><Image src={Dot} alt='logo'></Image></span>Custom Reporting</h3>
          <p className='text-[#072B2C] mt-2 text-[10px] lg:text-[10px] font-normal '>Lorem ipsum dolor sit amet consectetur. Potenti <br/> nullam at aenean ante ac enim mattis vestibulum <br/>vitae. Sit dolor id purus adipiscing dolor cursus <br/> sagittis pharetra sodales. Ut malesuada quam <br/>turpis euismod blandit. Rhoncus proin aliquet <br/> risus massa pellentesque elit. Non eget.</p>
        </div>
...
{/* 1 */}
      ...
      <section className='bg-gray-50 '>
        {/* <div>
          <div className='text-center'>
            <h3 className='uppercase text-[#372011] font-extrabold text-[40px]'>Simplify Your Life and Grow </h3>
          </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 container mx-auto lg:p-10 p-4">
    {/* <!-- Box 1 --> */}
